...
public class SoundWaveView extends View {
    ...
    private void initAtts(Context context, AttributeSet attrs) {
        ...
        voiceLineColor = typedArray.getColor(R.styleable.voiceView_voiceLine, Color.parseColor("#3688F8"));
        ...
        lineSpeed = typedArray.getInt(R.styleable.voiceView_lineSpeed, 120);
    ...
    public void drawPath(Canvas canvas) {
        ...
        int space = height / 6;
        for (int i = 0; i < 5; i++) {
            canvas.drawLine(0, (i + 1) * space, width, (i + 1) * space, paintVoicLine);
        }
